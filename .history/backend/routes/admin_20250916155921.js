...
class AdminPanel {
    ...
    async loadDashboard() {
        try {
            ...
            document.getElementById('totalVentas').textContent = `${Number(data.totalVentas || 0).toLocaleString()}`;
        ...
        try {
            ...
            tbody.innerHTML = productos.map(producto => `
                <tr>
                    <td>${producto.id}</td>
                    <td>
                        <img src="${producto.imagen_url || 'https://via.placeholder.com/50'}" 
                             alt="${producto.nombre}" 
                             class="rounded" 
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-primary me-1" onclick="adminPanel.editProduct(${producto.id})">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-danger" onclick="adminPanel.deleteProduct(${producto.id})">
        ...
        try {
            ...
            tbody.innerHTML = pedidos.map(pedido => `
                <tr>
                    ...
                    <td>
                        <select class="form-select form-select-sm" onchange="adminPanel.changeOrderStatus(${pedido.id}, this.value)">
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-info" onclick="adminPanel.viewOrderDetails(${pedido.id})">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <strong>Estado:</strong> <span class="badge bg-primary">${pedido.estado}</span><br>
                                        <strong>Total:</strong> ${Number(pedido.total).toLocaleString()}<br>
                                ...
                                ${pedido.notas ? `
                                    <h6>Notas:</h6>
                                    <p class="bg-light p-2 rounded">${pedido.notas}</p>
                                ` : ''}
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                <button type="button" class="btn btn-primary" onclick="adminPanel.generateWhatsAppLink(${pedido.id})">
    ...
    generateWhatsAppLink(orderId) {
        // Aquí puedes generar un enlace de WhatsApp personalizado
    ...
    generateWhatsAppLink(orderId) {
        return this.generateWhatsAppLink(orderId);
    }
}
