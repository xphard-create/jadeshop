  ...
  document.addEventListener("click", function (e) {
    ...
    if (e.target.classList.contains("btn-cantidad-menos")) {
      ...
      const cantidadActual = parseInt(
        e.target.parentElement.querySelector(".cantidad-display").textContent
      );
    ...
    .map(
      (producto) => `
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="card product-card h-100" data-categoria="${
              producto.categoria
            }">
                <!-- Imagen del producto -->
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <button 
                        ...
                        class="btn btn-agregar-carrito mt-auto ${
                          producto.stock > 0 ? "btn-primary" : "btn-secondary"
                        }"
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-2">
                            <div class="btn-group btn-group-sm" role="group">
                                <button class="btn btn-outline-secondary btn-cantidad-menos" data-producto-id="${
                                  item.id
                                }">
                                    <i class="fas fa-minus"></i>
                                </button>
                                <span class="btn btn-outline-secondary cantidad-display">${
                                  item.cantidad
                                }</span>
                                <button class="btn btn-outline-secondary btn-cantidad-mas" data-producto-id="${
                                  item.id
                                }">
                            ...
                            <button class="btn btn-outline-danger btn-sm btn-eliminar-producto" data-producto-id="${
                              item.id
                            }">
...
async function confirmarPedido() {
  ...
  // Verificar que esté logueado (doble verificación)
  if (!authManager.isLoggedIn()) {
    authManager.showLoginModal(() => confirmarPedido());
    return;
  }
    ...
    usuario.email
                        ...
                        <form id="clienteForm">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="direccion" rows="3" class="form-control" 
                                         placeholder="Calle, número, piso, depto, localidad" required></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="notas" rows="2" class="form-control" 
                                         placeholder="Instrucciones especiales, horarios preferidos, etc."></textarea>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="submitOrder">
                            <span id="submitText">Confirmar Pedido</span>
  ...
  modalElement
    ...
    .addEventListener("click", async function () {
      ...
      if (!telefono || !nombre || !email || !direccion) {
        mostrarToast(
      ...
      try {
        const pedidoData = {
          usuario_id: usuario.id, // ← NUEVO: vincular al usuario
        ...
        // Restaurar botón
        submitText.textContent = "Confirmar Pedido";
