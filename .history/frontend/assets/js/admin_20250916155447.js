                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Detalles del Pedido #${
                                  pedido.id
                                }</h5>
                            ...
                            <div class="modal-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <strong>Estado:</strong> <span class="badge bg-primary">${
                                          pedido.estado
                                        }</span><br>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" onclick="adminPanel.generateWhatsAppLink(${
                                  pedido.id
                                })">
