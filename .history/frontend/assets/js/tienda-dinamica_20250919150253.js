...
class TiendaDinamica {
  ...
  generarMensajeWhatsApp() {
    ...
    mensaje += `${"─".repeat(35)}\n`;
    mensaje += `1️⃣ Completa tus datos arriba\n`;
    mensaje += `2️⃣ Confirma el pedido\n`;
    mensaje += `3️⃣ Te responderemos con el total final\n`;
    mensaje += `4️⃣ Coordinaremos entrega y pago\n\n`;
